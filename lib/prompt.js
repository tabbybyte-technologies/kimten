...
function describeZodSchema(schema) {
  ...
  if (typeName === 'ZodArray' || type === 'array') {
    const arrayItem = defV3?.type ?? defV4?.element ?? defV4?.items;
